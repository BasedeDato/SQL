<html>
	...
	<body>
		<?php
			...
			$query = "SELECT nombre FROM cliente INNER JOIN actividad WHERE Nombre_Actividad ='Chartered certified' NOT IN (SELECT nombre FROM cliente INNER JOIN maquina WHERE Nombre_Maquina = 'whp')";
